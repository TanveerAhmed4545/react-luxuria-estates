...
const Contact = () => {
  return (
    <div className=" my-5 lg:my-9">
      <Helmet>
        <title>Luxuria Estates || Contact</title>
      </Helmet>
      ...
      <div className="text-center py-8 px-5">
          ...
          <p className="text-neutral-900 pt-6 w-full mx-auto lg:w-9/12">
            Contact Luxuria Estates for personalized assistance in discovering
            your dream residence. Reach us via phone, email, or visit our office
            for unparalleled luxury living.{" "}
          </p>
        </div>
        ...
        <div className="mt-6 lg:mt-12 flex gap-6 flex-col-reverse lg:flex-row px-6">
          ...
          <div className="rounded-2xl border border-neutral-900 border-opacity-10 lg:p-12 p-5 lg:basis-2/5 basis-full">
            ...
            <div className="p-6 bg-blue-400 bg-opacity-10 rounded-2xl my-6">
              ...
              <h3 className="font-bold pt-3">luxuria@support.com</h3>
            </div>
